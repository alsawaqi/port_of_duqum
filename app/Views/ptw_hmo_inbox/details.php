...
$back_html = anchor(get_uri("ptw_hmo_inbox"), "<i data-feather='arrow-left' class='icon-16'></i> " . app_lang("back"), ["class" => "btn btn-outline-light"]);

echo view("ptw_common/details_panel", [
    "app" => $app,
    "page_title" => "HMO Review - PTW Details",
    "current_stage" => "hmo",
    ...
    "review_groups" => $review_groups ?? ["hsse" => [], "hmo" => $reviews ?? [], "terminal" => []],
