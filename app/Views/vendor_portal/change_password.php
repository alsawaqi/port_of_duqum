<div id="page-content" class="page-wrapper clearfix pod-page-shell pod-vendor-page">
    ...
    echo view("includes/pod_page_header", [
        ...
        "subtitle" => "Update the password used to access your vendor account.",
        "icon" => "key",
        "breadcrumbs" => [
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        This password belongs to your login account and applies to every CR linked to your email.
                    </div>

                    <?php echo form_open(get_uri("vendor_portal/save_password"), [
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#vendor-password-form").appForm({
            isModal: false,
            onSuccess: function(result) {
                appAlert.success(result.message);
                document.getElementById("vendor-password-form").reset();
            },
