...
$back_html = anchor(get_uri("ptw_terminal_inbox"), "<i data-feather='arrow-left' class='icon-16'></i> " . app_lang("back"), ["class" => "btn btn-outline-light"]);

echo view("ptw_common/details_panel", [
    "app" => $app,
    "page_title" => "Terminal Review - PTW Details",
    ...
    "review_groups" => $review_groups ?? ["hsse" => [], "hmo" => [], "terminal" => $reviews ?? []],
