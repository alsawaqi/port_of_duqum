<div id="page-content" class="page-wrapper clearfix gp-pro-page pod-page-shell pod-tender-page">
    ...
    echo view("includes/tender_page_header", [
        "title" => app_lang("tender_finance_users"),
        "subtitle" => "Maintain finance tender reviewers and approval coverage.",
        "icon" => "user-check"
    ]);
    ?>
    <div class="card gp-pro-card">
        ...
        <div class="table-responsive gp-pro-table-shell">
                <table id="tender-finance-users-table" class="display" cellspacing="0" width="100%"></table>
        </div>
    </div>
</div>
...
$(document).ready(function () {
    $("#tender-finance-users-table").appTable({
        source: '<?php echo_uri("tender_finance_users/list_data"); ?>',
        columns: [
