...
<?php echo form_open(get_uri("tender_committee_users/save"), ["id" => "tender-committee-user-form", "class" => "general-form", "role" => "form"]); ?>
...
$(document).ready(function () {
    $("#tender-committee-user-form").appForm({
        onSuccess: function () {
            $("#tender-committee-users-table").appTable({ newData: true });
        }
    });
    $(".select2").select2();
});
