...
<div id="page-content" class="page-wrapper clearfix gp-pro-page">
        ...
        <div class="card-body">
            ...
            <?php if ((int) $pending_count === 0) { ?>
                <div class="alert alert-success mt15 mb0">
                    All bids in this tender have already been technically finalized. Procurement can now move the tender to commercial evaluation.
                </div>
            <?php } else { ?>
    ...
    <div class="card gp-pro-card mb15">
        ...
        <div class="card-body">
            <?php echo form_open_multipart(get_uri("tender_technical_inbox/request_clarification"), [
                "id" => "technical-general-clarification-form",
                "class" => "general-form",
                "role" => "form"
            ]); ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group mb15">
                            <label>Subject</label>
                            <input type="text" name="subject" class="form-control" maxlength="255" value="General technical clarification request">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="form-group mb15">
                            <label>Message</label>
                            <textarea name="message" class="form-control" rows="2" required placeholder="Ask procurement a general technical clarification for this tender"></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group mb15">
...
$(document).ready(function () {
    $("#technical-general-clarification-form").appForm({
