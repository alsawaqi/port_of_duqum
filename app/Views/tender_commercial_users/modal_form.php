...
<?php echo form_open(get_uri("tender_commercial_users/save"), ["id" => "tender-commercial-user-form", "class" => "general-form", "role" => "form"]); ?>
...
$(document).ready(function () {
        $("#tender-commercial-user-form").appForm({
        onSuccess: function () {
            $("#tender-commercial-users-table").appTable({ newData: true });
        }
    });
    $(".select2").select2();
});
