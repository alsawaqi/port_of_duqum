<div id="page-content" class="page-wrapper clearfix gp-pro-page pod-page-shell pod-gate-pass-page">
    <?php echo view("includes/gate_pass_page_header", [
        "title" => app_lang("gate_pass_visitors"),
        "subtitle" => "Manage visitor portal accounts, contact numbers, OTP channels, and access status.",
        "icon" => "users",
        "breadcrumbs" => [
            ["label" => "Gate Pass"],
            ["label" => app_lang("gate_pass_visitors")]
        ]
    ]); ?>
        ...
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                <?php echo modal_anchor(
                    ...
                    ["class" => "btn btn-primary gp-pro-btn gp-pro-btn-icon", "title" => app_lang("add_visitor")]
                ); ?>
            </div>
        </div>
