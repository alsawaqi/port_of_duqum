<?php echo form_open(get_uri("gate_pass_commercial_users/save"), ["id" => "gate-pass-commercial-user-form", "class" => "general-form", "role" => "form"]); ?>
...
$(document).ready(function () {
    $("#gate-pass-commercial-user-form").appForm({
        onSuccess: function () {
            $("#gate-pass-commercial-users-table").appTable({ newData: true });
        }
    });
    $(".select2").select2();
});
