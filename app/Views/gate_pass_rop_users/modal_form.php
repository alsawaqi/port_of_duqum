<?php echo form_open(get_uri("gate_pass_rop_users/save"), ["id" => "gate-pass-rop-user-form", "class" => "general-form", "role" => "form"]); ?>
...
$(document).ready(function () {
    $("#gate-pass-rop-user-form").appForm({
        onSuccess: function () {
            $("#gate-pass-rop-users-table").appTable({ newData: true });
        }
    });
    $(".select2").select2();
});
