...
$colors = ["#465fff", "#12b76a", "#f79009", "#06aed5", "#7a5af8", "#667085", "#f04438", "#16b364"];
...
$stage_chart = [
    ...
    "data" => [
        ...
        "datasets" => [[
            ...
            "backgroundColor" => ["#465fff", "#06aed5", "#f79009", "#12b76a", "#7a5af8", "#667085"],
            "borderWidth" => 0,
            "barThickness" => 18,
            "maxBarThickness" => 22
        ]]
...
<div class="card bg-white pod-dashboard-card pod-kpi-widget pod-gate-pass-widget">
    <div class="card-header pod-dashboard-card-header d-flex justify-content-between align-items-center">
        <div class="pod-dashboard-title">
            <span class="pod-dashboard-icon"><i data-feather="log-in" class="icon-16"></i></span>
            <span>Gate Pass KPIs</span>
        </div>
        <span class="pod-dashboard-chip"><?php echo esc($scope_label ?? ""); ?></span>
    </div>

    <div class="card-body">
        <div class="pod-kpi-summary">
            <div class="pod-kpi-metric">
                <div class="pod-kpi-label">In progress</div>
                <div class="pod-kpi-value"><?php echo $in_progress; ?></div>
                <div class="pod-kpi-hint">Active requests moving through review</div>
            </div>
            <div class="pod-kpi-metric">
                <div class="pod-kpi-label">Issued (Valid)</div>
                <div class="pod-kpi-value"><?php echo $issued_valid; ?></div>
                <div class="pod-kpi-hint">Currently usable gate passes</div>
            </div>
        </div>

        <div class="pod-dashboard-chart-grid">
            <div class="pod-chart-panel">
                <div class="pod-section-heading">Requests by stage <span><?php echo $stage_total; ?> total</span></div>
