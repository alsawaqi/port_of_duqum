...
$widget_uid = "pod-gp-reject-" . uniqid();
...
<div class="card bg-white pod-dashboard-card pod-rejection-widget pod-gate-pass-widget">
    <div class="card-header pod-dashboard-card-header d-flex justify-content-between align-items-center">
        <div class="pod-dashboard-title">
            ...
            <span>Gate Pass Top Rejection Reasons</span>
        </div>
