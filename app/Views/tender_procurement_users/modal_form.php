...
<?php echo form_open(get_uri("tender_procurement_users/save"), ["id" => "tender-procurement-user-form", "class" => "general-form", "role" => "form"]); ?>
...
$(document).ready(function () {
    $("#tender-procurement-user-form").appForm({
        onSuccess: function () {
            $("#tender-procurement-users-table").appTable({ newData: true });
        }
    });
    $(".select2").select2();
});
