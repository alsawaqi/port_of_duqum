<div id="page-content" class="page-wrapper clearfix gp-details-page">
    ...
    if ($status === "department_approved" || $status === "commercial_approved") $status_class = "gp-badge-soft-success";
    ...
    <div class="card gp-card mb15">
        ...
        <div class="p20 pt10">
            <div class="gp-grid">
                ...
                <?php if (!empty($request->fee_amount) || $request->fee_amount === "0"): ?>
                <div class="gp-info">
                    <div class="gp-info-icon"><i data-feather="dollar-sign" class="icon-18"></i></div>
                    <div>
                        <div class="gp-label"><?php echo app_lang("fee_amount"); ?></div>
                        <div class="gp-value">
                            <?php echo esc(($request->currency ?? "") . " " . ($request->fee_amount !== null ? number_format((float)$request->fee_amount, 2) : "-")); ?>
                            <?php if (!empty($request->fee_is_waived)): ?>
                                <span class="badge gp-badge-soft-warning"><?php echo app_lang("waived"); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
    ...
    <div id="gp-commercial-visitors-card" class="card gp-card mb15">
        ...
        <div class="table-responsive p15 p-sm-10 gp-table-wrap">
            <table id="gp-commercial-visitors-table" class="display" width="100%" cellspacing="0"></table>
        </div>
    </div>

    <div id="gp-commercial-vehicles-card" class="card gp-card mb15">
        <div class="gp-section-title gp-section-title-row">
            <div class="d-flex align-items-center">
        ...
        <div class="table-responsive p15 p-sm-10 gp-table-wrap">
            <table id="gp-commercial-vehicles-table" class="display" width="100%" cellspacing="0"></table>
        </div>
    </div>
</div>
