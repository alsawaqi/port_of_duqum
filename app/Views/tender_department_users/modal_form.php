...
<?php echo form_open(get_uri("tender_department_users/save"), ["id" => "tender-department-user-form", "class" => "general-form", "role" => "form"]); ?>
...
$(document).ready(function () {
    function loadDepartments(companyId, selectedId) {
        ...
        $.getJSON("<?php echo_uri('tender_department_users/departments_by_company'); ?>", {company_id: companyId})
            .done(function (resp) {
    ...
    $("#tender-department-user-form").appForm({
        onSuccess: function () {
            $("#tender-department-users-table").appTable({ newData: true });
        }
    });
});
</script>