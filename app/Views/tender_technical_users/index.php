<div id="page-content" class="page-wrapper clearfix gp-pro-page pod-page-shell pod-tender-page">
    ...
    echo view("includes/tender_page_header", [
        "title" => app_lang("tender_technical_users"),
        "subtitle" => "Maintain technical evaluators for tender review assignments.",
        "icon" => "user-check"
    ]);
    ?>
        ...
        <div class="page-title clearfix">
            ...
            <div class="title-button-group">
                ...
                <?php echo modal_anchor(
                    ...
                    ["class" => "btn btn-primary gp-pro-btn gp-pro-btn-icon", "title" => app_lang("add_tender_technical_user")]
                ); ?>
                <?php } ?>
            </div>
        </div>
