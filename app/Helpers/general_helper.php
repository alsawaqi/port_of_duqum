...
if (!function_exists('format_gate_pass_status')) {

    /**
     * Convert gate pass status code to human-friendly text.
     * Example: department_approved => Department Approved
     */
    function format_gate_pass_status($status, $empty_value = "-") {
