        ...
        try {
            ...
            if (!$id) {
                ...
                $user_data = [
                    ...
                    "job_title" => "Tender Procurement User",
                ...
                $save_id = $this->Tender_procurement_users_model->ci_save($pivot_data);
            } else {
                ...
                $save_id = $this->Tender_procurement_users_model->ci_save($pivot_data, $id);
            }
