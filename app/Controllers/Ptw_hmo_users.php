...
class Ptw_hmo_users extends Security_Controller
{
    ...
    {
        $this->access_only_ptw("hmo_users", "view");
        return $this->template->rander("ptw_hmo_users/index");
    }
    ...
    public function modal_form()
    {
        ...
        $this->access_only_ptw("hmo_users", $id ? "update" : "create");
        $model_info = null;

        if ($id) {
            $model_info = $this->Ptw_hmo_users_model->get_details(["id" => $id])->getRow();
        }
        ...
        return $this->template->view("ptw_hmo_users/modal_form", [
    ...
    public function save()
    {
        ...
        if (!$id) {
            ...
            $save_id = $this->Ptw_hmo_users_model->ci_save($pivot_data);
        } else {
            $pivot = $this->Ptw_hmo_users_model->get_one($id);
            ...
            $save_id = $this->Ptw_hmo_users_model->ci_save($pivot_update, $id);
        }
    ...
    public function delete()
    {
        ...
        $this->access_only_ptw("hmo_users", "delete");
    ...
    public function list_data()
    {
        ...
        $list = $this->Ptw_hmo_users_model->get_details()->getResult();
        $result = [];
    ...
    private function _make_row($data)
    {
        ...
        $options = modal_anchor(
            get_uri("ptw_hmo_users/modal_form"),
        ...
        $options .= js_anchor(
            ...
            [
                ...
                "data-id" => $data->id,
                "data-action-url" => get_uri("ptw_hmo_users/delete"),
