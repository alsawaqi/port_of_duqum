...
class Ptw_hsse_users extends Security_Controller
{
    ...
    {
        $this->access_only_ptw("hsse_users", "view");
        return $this->template->rander("ptw_hsse_users/index");
    }
    ...
    public function modal_form()
    {
        ...
        if ($id) {
            $model_info = $this->Ptw_hsse_users_model->get_details(["id" => $id])->getRow();
        }
        ...
        return $this->template->view("ptw_hsse_users/modal_form", [
    ...
    public function delete()
    {
        ...
        $this->access_only_ptw("hsse_users", "delete");
    ...
    public function list_data()
    {
        ...
        $list = $this->Ptw_hsse_users_model->get_details()->getResult();
        $result = [];
    ...
    private function _make_row($data)
    {
        ...
        $options .= js_anchor(
            ...
            [
                ...
                "data-id" => $data->id,
                "data-action-url" => get_uri("ptw_hsse_users/delete"),
