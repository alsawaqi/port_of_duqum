...
// ---------------------------------------------------------
// Countries
$view_data['can_view_countries']   = get_array_value($permissions, "can_view_countries");
$view_data['can_create_countries'] = get_array_value($permissions, "can_create_countries");
$view_data['can_update_countries'] = get_array_value($permissions, "can_update_countries");
$view_data['can_delete_countries'] = get_array_value($permissions, "can_delete_countries");

// Regions
$view_data['can_view_regions']   = get_array_value($permissions, "can_view_regions");
$view_data['can_create_regions'] = get_array_value($permissions, "can_create_regions");
$view_data['can_update_regions'] = get_array_value($permissions, "can_update_regions");
$view_data['can_delete_regions'] = get_array_value($permissions, "can_delete_regions");

// Cities
$view_data['can_view_cities']   = get_array_value($permissions, "can_view_cities");
$view_data['can_create_cities'] = get_array_value($permissions, "can_create_cities");
$view_data['can_update_cities'] = get_array_value($permissions, "can_update_cities");
$view_data['can_delete_cities'] = get_array_value($permissions, "can_delete_cities");

// Legal Types
$view_data['can_view_legal_types']   = get_array_value($permissions, "can_view_legal_types");
$view_data['can_create_legal_types'] = get_array_value($permissions, "can_create_legal_types");
$view_data['can_update_legal_types'] = get_array_value($permissions, "can_update_legal_types");
$view_data['can_delete_legal_types'] = get_array_value($permissions, "can_delete_legal_types");

// Vendor Categories
$view_data['can_view_vendor_categories']   = get_array_value($permissions, "can_view_vendor_categories");
$view_data['can_create_vendor_categories'] = get_array_value($permissions, "can_create_vendor_categories");
$view_data['can_update_vendor_categories'] = get_array_value($permissions, "can_update_vendor_categories");
$view_data['can_delete_vendor_categories'] = get_array_value($permissions, "can_delete_vendor_categories");

// Vendor Sub Categories
$view_data['can_view_vendor_sub_categories']   = get_array_value($permissions, "can_view_vendor_sub_categories");
$view_data['can_create_vendor_sub_categories'] = get_array_value($permissions, "can_create_vendor_sub_categories");
$view_data['can_update_vendor_sub_categories'] = get_array_value($permissions, "can_update_vendor_sub_categories");
$view_data['can_delete_vendor_sub_categories'] = get_array_value($permissions, "can_delete_vendor_sub_categories");

// Vendor Groups
$view_data['can_view_vendor_groups']   = get_array_value($permissions, "can_view_vendor_groups");
$view_data['can_create_vendor_groups'] = get_array_value($permissions, "can_create_vendor_groups");
...
$view_data['can_update_vendor_group_fees'] = get_array_value($permissions, "can_update_vendor_group_fees");
$view_data['can_delete_vendor_group_fees'] = get_array_value($permissions, "can_delete_vendor_group_fees");

// Vendor Document Types
$view_data['can_view_vendor_document_types']   = get_array_value($permissions, "can_view_vendor_document_types");
$view_data['can_create_vendor_document_types'] = get_array_value($permissions, "can_create_vendor_document_types");
$view_data['can_update_vendor_document_types'] = get_array_value($permissions, "can_update_vendor_document_types");
$view_data['can_delete_vendor_document_types'] = get_array_value($permissions, "can_delete_vendor_document_types");

// Vendors
$view_data['can_view_vendors']   = get_array_value($permissions, "can_view_vendors");
$view_data['can_create_vendors'] = get_array_value($permissions, "can_create_vendors");
$view_data['can_update_vendors'] = get_array_value($permissions, "can_update_vendors");
$view_data['can_delete_vendors'] = get_array_value($permissions, "can_delete_vendors");

// Vendor Specialties
$view_data['can_view_vendor_specialties']   = get_array_value($permissions, "can_view_vendor_specialties");
$view_data['can_filter_vendor_specialties'] = get_array_value($permissions, "can_filter_vendor_specialties");

// Vendor Update Requests
$view_data['can_view_vendor_update_requests']   = get_array_value($permissions, "can_view_vendor_update_requests");
$view_data['can_review_vendor_update_requests'] = get_array_value($permissions, "can_review_vendor_update_requests");
$view_data['can_approve_vendor_update_requests'] = get_array_value($permissions, "can_approve_vendor_update_requests");
$view_data['can_reject_vendor_update_requests'] = get_array_value($permissions, "can_reject_vendor_update_requests");
...
foreach ($gate_pass_sections as $section) {
    ...
    $view_data['can_update_gate_pass_' . $section]  = get_array_value($permissions, 'can_update_gate_pass_' . $section);
    $view_data['can_delete_gate_pass_' . $section]  = get_array_value($permissions, 'can_delete_gate_pass_' . $section);
}
...
foreach ($ptw_sections as $section) {
    ...
    $view_data['can_update_ptw_' . $section] = get_array_value($permissions, 'can_update_ptw_' . $section);
    $view_data['can_delete_ptw_' . $section] = get_array_value($permissions, 'can_delete_ptw_' . $section);
}
    ...
    function save_permissions() {
        ...
        // Master Data permissions
        // ---------------------------------------------------------
        // Master Data permissions (CRUD) - read from POST
        // ---------------------------------------------------------
        // Countries
        $can_view_countries   = $this->request->getPost('can_view_countries');
        $can_create_countries = $this->request->getPost('can_create_countries');
        $can_update_countries = $this->request->getPost('can_update_countries');
        $can_delete_countries = $this->request->getPost('can_delete_countries');

        // Regions
        $can_view_regions   = $this->request->getPost('can_view_regions');
        $can_create_regions = $this->request->getPost('can_create_regions');
        $can_update_regions = $this->request->getPost('can_update_regions');
        $can_delete_regions = $this->request->getPost('can_delete_regions');

        // Cities
        $can_view_cities   = $this->request->getPost('can_view_cities');
        $can_create_cities = $this->request->getPost('can_create_cities');
        $can_update_cities = $this->request->getPost('can_update_cities');
        $can_delete_cities = $this->request->getPost('can_delete_cities');

        // Legal Types
        $can_view_legal_types   = $this->request->getPost('can_view_legal_types');
        $can_create_legal_types = $this->request->getPost('can_create_legal_types');
        $can_update_legal_types = $this->request->getPost('can_update_legal_types');
        $can_delete_legal_types = $this->request->getPost('can_delete_legal_types');

        // Vendor Categories
        $can_view_vendor_categories   = $this->request->getPost('can_view_vendor_categories');
        $can_create_vendor_categories = $this->request->getPost('can_create_vendor_categories');
        $can_update_vendor_categories = $this->request->getPost('can_update_vendor_categories');
        $can_delete_vendor_categories = $this->request->getPost('can_delete_vendor_categories');

        // Vendor Sub Categories
        $can_view_vendor_sub_categories   = $this->request->getPost('can_view_vendor_sub_categories');
        $can_create_vendor_sub_categories = $this->request->getPost('can_create_vendor_sub_categories');
        $can_update_vendor_sub_categories = $this->request->getPost('can_update_vendor_sub_categories');
        $can_delete_vendor_sub_categories = $this->request->getPost('can_delete_vendor_sub_categories');

        // Vendor Groups
        $can_view_vendor_groups   = $this->request->getPost('can_view_vendor_groups');
        $can_create_vendor_groups = $this->request->getPost('can_create_vendor_groups');
        ...
        $can_update_vendor_group_fees = $this->request->getPost('can_update_vendor_group_fees');
        $can_delete_vendor_group_fees = $this->request->getPost('can_delete_vendor_group_fees');

        // Vendor Document Types
        $can_view_vendor_document_types   = $this->request->getPost('can_view_vendor_document_types');
        $can_create_vendor_document_types = $this->request->getPost('can_create_vendor_document_types');
        $can_update_vendor_document_types = $this->request->getPost('can_update_vendor_document_types');
        $can_delete_vendor_document_types = $this->request->getPost('can_delete_vendor_document_types');

        // Vendors
        $can_view_vendors   = $this->request->getPost('can_view_vendors');
        $can_create_vendors = $this->request->getPost('can_create_vendors');
        $can_update_vendors = $this->request->getPost('can_update_vendors');
        $can_delete_vendors = $this->request->getPost('can_delete_vendors');

        // Vendor Specialties
        $can_view_vendor_specialties   = $this->request->getPost('can_view_vendor_specialties');
        $can_filter_vendor_specialties = $this->request->getPost('can_filter_vendor_specialties');

        // Vendor Update Requests
        $can_view_vendor_update_requests   = $this->request->getPost('can_view_vendor_update_requests');
        $can_review_vendor_update_requests = $this->request->getPost('can_review_vendor_update_requests');
        $can_approve_vendor_update_requests = $this->request->getPost('can_approve_vendor_update_requests');
        $can_reject_vendor_update_requests = $this->request->getPost('can_reject_vendor_update_requests');
        // Vendor Update Requests (Group by Vendor)
        ...
        foreach ($gate_pass_sections as $section) {
            ...
            $gate_pass_permissions['can_create_gate_pass_' . $section] = $this->request->getPost('can_create_gate_pass_' . $section);
            $gate_pass_permissions['can_update_gate_pass_' . $section]  = $this->request->getPost('can_update_gate_pass_' . $section);
            $gate_pass_permissions['can_delete_gate_pass_' . $section]  = $this->request->getPost('can_delete_gate_pass_' . $section);
        }
        ...
        foreach ($ptw_sections as $section) {
            ...
            $ptw_permissions['can_create_ptw_' . $section] = $this->request->getPost('can_create_ptw_' . $section);
            $ptw_permissions['can_update_ptw_' . $section] = $this->request->getPost('can_update_ptw_' . $section);
            $ptw_permissions['can_delete_ptw_' . $section] = $this->request->getPost('can_delete_ptw_' . $section);
        }
        ...
        $permissions = array(
            ...
            "can_update_countries" => $can_update_countries,
            "can_delete_countries" => $can_delete_countries,

            // Regions
            "can_view_regions"   => $can_view_regions,
            "can_create_regions" => $can_create_regions,
            "can_update_regions" => $can_update_regions,
            "can_delete_regions" => $can_delete_regions,

            // Cities
            "can_view_cities"   => $can_view_cities,
            "can_create_cities" => $can_create_cities,
            "can_update_cities" => $can_update_cities,
            "can_delete_cities" => $can_delete_cities,

            // Legal Types
            "can_view_legal_types"   => $can_view_legal_types,
            "can_create_legal_types" => $can_create_legal_types,
            "can_update_legal_types" => $can_update_legal_types,
            "can_delete_legal_types" => $can_delete_legal_types,

            // Vendor Categories
            "can_view_vendor_categories"   => $can_view_vendor_categories,
            "can_create_vendor_categories" => $can_create_vendor_categories,
            "can_update_vendor_categories" => $can_update_vendor_categories,
            "can_delete_vendor_categories" => $can_delete_vendor_categories,

            // Vendor Sub Categories
            "can_view_vendor_sub_categories"   => $can_view_vendor_sub_categories,
            "can_create_vendor_sub_categories" => $can_create_vendor_sub_categories,
            "can_update_vendor_sub_categories" => $can_update_vendor_sub_categories,
            "can_delete_vendor_sub_categories" => $can_delete_vendor_sub_categories,

            // Vendor Groups
            "can_view_vendor_groups"   => $can_view_vendor_groups,
            ...
            "can_create_vendor_group_fees" => $can_create_vendor_group_fees,
            "can_update_vendor_group_fees" => $can_update_vendor_group_fees,
            "can_delete_vendor_group_fees" => $can_delete_vendor_group_fees,

            // Vendor Document Types
            "can_view_vendor_document_types"   => $can_view_vendor_document_types,
            "can_create_vendor_document_types" => $can_create_vendor_document_types,
            "can_update_vendor_document_types" => $can_update_vendor_document_types,
            "can_delete_vendor_document_types" => $can_delete_vendor_document_types,

            // Vendors
            "can_view_vendors"   => $can_view_vendors,
            "can_create_vendors" => $can_create_vendors,
            "can_update_vendors" => $can_update_vendors,
            "can_delete_vendors" => $can_delete_vendors,

            // Vendor Specialties
            "can_view_vendor_specialties"   => $can_view_vendor_specialties,
            "can_filter_vendor_specialties" => $can_filter_vendor_specialties,

            // Vendor Update Requests
            "can_view_vendor_update_requests"   => $can_view_vendor_update_requests,
            "can_review_vendor_update_requests" => $can_review_vendor_update_requests,
            "can_approve_vendor_update_requests" => $can_approve_vendor_update_requests,
