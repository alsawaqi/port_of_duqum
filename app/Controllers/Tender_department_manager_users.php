    ...
    public function save()
    {
        ...
        if (!$id) {
            ...
            $user_data = [
                ...
                "job_title" => "Tender Department Manager",
            ...
            $save_id = $this->Tender_department_manager_users_model->ci_save($pivot_data);
        } else {
            ...
            $save_id = $this->Tender_department_manager_users_model->ci_save($pivot_data, $id);
        }
