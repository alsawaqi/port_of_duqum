...
class Gate_pass_security_users extends Security_Controller
{
    ...
    {
        $this->access_only_gate_pass("security_users", "view");
        return $this->template->rander("gate_pass_security_users/index");
    }
    ...
    public function modal_form()
    {
        ...
        $model_info = null;
        if ($id) {
            $model_info = $this->Gate_pass_security_users_model->get_details(["id" => $id])->getRow();
        }
        ...
        return $this->template->view("gate_pass_security_users/modal_form", $view_data);
    }
    ...
    public function delete()
    {
        ...
        $this->access_only_gate_pass("security_users", "delete");
        $id = (int)$this->request->getPost("id");
    ...
    {
        $this->access_only_gate_pass("security_users", "view");
        $list_data = $this->Gate_pass_security_users_model->get_details()->getResult();
        $result = [];
    ...
    private function _make_row($data)
    {
        ...
        if (!empty($data->id)) {
            ...
            $options .= js_anchor(
                ...
                ["title" => app_lang("delete"), "class" => "delete", "data-id" => $data->id, "data-action-url" => get_uri("gate_pass_security_users/delete"), "data-action" => "delete-confirmation"]
            );
        }
