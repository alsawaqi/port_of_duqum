...
class Tender_committee_users extends Security_Controller
{
    ...
    private function _ensure_role(string $title, array $keys): int
{
    ...
    {
        $list = $this->Tender_committee_users_model->get_details()->getResult();
        $result = [];
    ...
    public function modal_form()
    {
        ...
        return $this->template->view("tender_committee_users/modal_form", [
    ...
    public function save()
    {
        ...
        $this->db->transStart();
        try {
            $role_id = $this->_ensure_role("Tender Committee", [
                "can_view_tender_committee",
                "can_update_tender_committee",
                "can_tender_open_bids_3key"
            ]);
            ...
            if (!$id) {
                ...
                $user_data = [
                    ...
                    "job_title" => "Tender Committee User",
                ...
                $save_id = $this->Tender_committee_users_model->ci_save($pivot_data);
            } else {
                ...
                $save_id = $this->Tender_committee_users_model->ci_save($pivot_data, $id);
            }
    ...
    public function delete()
    {
        ...
        $this->db->transStart();
        $this->Tender_committee_users_model->delete($id);
        if ($pivot->user_id) {
