...
class Gate_pass_purposes extends Security_Controller
{
    ...
    function index()
    {
        $this->access_only_gate_pass("purposes", "view");
        return $this->template->rander("gate_pass_purposes/index");
    }
    ...
    function modal_form()
    {
        ...
        $this->access_only_gate_pass("purposes", $id ? "update" : "create");

        $view_data["model_info"] = $this->Gate_pass_purposes_model->get_one($id);
        return $this->template->view("gate_pass_purposes/modal_form", $view_data);
    }
    ...
    function save()
    {
        ...
        $save_id = $this->Gate_pass_purposes_model->ci_save($data, $id);
    ...
    {
        $this->access_only_gate_pass("purposes", "view");
        $list_data = $this->Gate_pass_purposes_model->get_details()->getResult();
        $result = [];
    ...
    function delete()
    {
        ...
        $this->access_only_gate_pass("purposes", "delete");

        $id = $this->request->getPost("id");
        if ($this->Gate_pass_purposes_model->delete($id)) {
    ...
    {
        $data = $this->Gate_pass_purposes_model->get_details(["id" => $id])->getRow();
    ...
    private function _make_row($data)
    {
        ...
        $options .= js_anchor(
            ...
            [
                ...
                "class" => "delete",
                "data-id" => $data->id,
                "data-action-url" => get_uri("gate_pass_purposes/delete"),
