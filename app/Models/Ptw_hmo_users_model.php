...
class Ptw_hmo_users_model extends Crud_model
{
    protected $table = null;

    public function __construct()
    {
        $this->table = "ptw_hmo_users";
        parent::__construct($this->table);
    }

    public function get_details($options = [])
    {
        $ptw = $this->db->prefixTable("ptw_hmo_users");
    ...
    public function is_hmo_user($user_id): bool
    {
        $table = $this->db->prefixTable("ptw_hmo_users");
        $row = $this->db->query(
